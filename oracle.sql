...
SELECT * FROM EMPLOYEES WHERE FIRST_NAME BETWEEN 'Douglas' AND 'Steven';-- operacion que se encuentre entre estos dos nombres
...
SELECT * FROM EMPLOYEES;
SELECT FIRST_NAME,SALARY,COMMISSION_PCT,SALARY+(SALARY*COMMISSION_PCT)AS "Salario Total" FROM EMPLOYEES WHERE COMMISSION_PCT IS NOT NULL;
...
SELECT INITCAP('ESTO ES UNA PRUEBA') FROM DUAL;--Pone de tipo oracion 
...
SELECT CONCAT(FIRST_NAME,LAST_NAME) FROM EMPLOYEES;--SOPORTA SOLO 2 ARGUMENTOS -> StevenKing

SELECT CONCAT(FIRST_NAME,CONCAT(' ',LAST_NAME)) FROM EMPLOYEES;--AHORA SI ->Steven King
...
-- LENGTH
SELECT FIRST_NAME,LENGTH(FIRST_NAME) FROM EMPLOYEES;-- RESULTADO -> Steven 6

SELECT FIRST_NAME FROM EMPLOYEES WHERE LENGTH(FIRST_NAME)=6;--SELECCIONA LAS QUE TIENE 6 CARATERES COMO Daniel
...
SELECT FIRST_NAME,SUBSTR(FIRST_NAME,1,3)FROM EMPLOYEES;-- ->Steven Ste

SELECT FIRST_NAME,SUBSTR(FIRST_NAME,3)FROM EMPLOYEES;-- ->Steven even SELECCIONA DESDE EL 4

-- QUIERO SACAR LA ULTIMA POCISION
SELECT FIRST_NAME,SUBSTR(FIRST_NAME,LENGTH(FIRST_NAME),1)FROM EMPLOYEES;-- FUNCION ANIDADA
...
SELECT FIRST_NAME,INSTR(FIRST_NAME,'a')FROM EMPLOYEES;-- FUNCION ANIDADA -->Neena 5
