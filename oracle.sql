...
/*• Copiar y ejecutar en el SqlDeveloper las siguientes líneas. Debe crear 2
tablas llamadas coches1 y coches2 y cargarla con datos. En un capítulo
posterior veremos como crear tablas y como insertar datos en las
mismas. Por ahora nos limitamos a crearlas
*/
